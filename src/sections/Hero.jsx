...
const Hero = () => {
    ...
    return (
        <div className="flex flex-col mx-40 max-xl:flex-col max-xl:mx-auto max-sm:max-w-sm max-2xl:max-w-2xl max-w-full max-xl:-mt-60 max-2xl:mt-198 max-lg:max-w-lg max-md:-mt-120 max-lg:-mt-100 max-lg:py-30 h-full relative">
            <div className="max-xl:mb-2 mb-50 mt-25">
            <div className="relative max-sm:p-5 flex max-xl:flex-col flex-col text-white max-xl:gap-7 gap-12 max-xl:mb-15">

                <h2 className="text-white font-gilroy font-extrabold max-2xl:text-7xl opacity-25">01</h2>
                <div className="flex flex-row  absolute max-sm:mt-5 max-2xl:mt-4 items-center align-middle max-sm:ml-7">
                    ...
                    <h2 className="uppercase tracking-widest font-gilroy font-extrabold text-amber-200 max-2xl:text-2xl">get started</h2>
                </div>

                <h2 className="font-chronicle-black font-semibold max-xl:text-6xl max-xl:max-w-full text-5xl max-w-[400px]">What level of  hiker are you?</h2>
                ...
                {isMaxXL ? (
                    ...
                    <div className="flex relative flex-row ml-130 -mt-180 w-[500px] mb-5">
                        <img src="/images/01.png" alt="01" />
                    </div>
                )}
            ...
            <div className="max-xl:mb-2 mb-50">
                <div className="relative max-sm:p-5 flex max-xl:flex-col flex-row text-white max-xl:gap-7 gap-12 max-xl:mb-15">
                    {isMaxXL ? (
                        ...
                        <>
                            ...
                            <div className="ml-160 max-w-full mt-5 flex flex-col gap-7  relative mb-80">
                                <h2 className="text-white font-gilroy font-extrabold text-7xl opacity-25">
                                    02
                                </h2>

                                <div className="flex flex-row absolute gap-2 max-sm:mt-5 max-2xl:mt-4 items-center w-200 align-middle max-sm:ml-7">
                                    <div className="line-left max-sm:-mt-2 max-lg:-mt-1 max-2xl:ml-3" />
                                    <h2 className="uppercase tracking-widest font-gilroy font-extrabold text-amber-200 max-2xl:text-2xl">
                                        Hiking Essentials
                                    </h2>
                                ...
                                <h2 className="font-chronicle-black font-semibold max-xl:text-6xl max-xl:max-w-full w-[400px] text-4xl ">
                                    Picking the right Hiking Gear!
                                </h2>
            ...
            <div className="max-xl:mb-2 mb-0">
                <div className="relative max-sm:p-5 flex max-xl:flex-col flex-col text-white max-xl:gap-7 gap-12 max-xl:mb-15">
                    ...
                    <h2 className="text-white font-gilroy font-extrabold max-2xl:text-7xl opacity-25">03</h2>
                    <div className="flex flex-row  absolute max-sm:mt-5 max-2xl:mt-4 items-center align-middle max-sm:ml-7">
                        <div  className="line-left max-sm:-mt-2 max-lg:-mt-1 max-2xl:ml-3"/>
                        <h2 className="uppercase tracking-widest font-gilroy font-extrabold text-amber-200 max-2xl:text-2xl">where you go is the key</h2>
                    </div>

                    <h2 className="font-chronicle-black font-semibold max-xl:text-6xl max-xl:max-w-full text-5xl max-w-[400px]">Understand Your Map & Timing</h2>
