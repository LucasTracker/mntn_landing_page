...
const Hero = () => {
    ...
    return (
        <div className="flex flex-col mx-80 max-2xl:ml-20 max-xl:flex-col max-xl:mx-auto max-sm:max-w-sm max-2xl:max-w-2xl max-w-full max-xl:-mt-60 max-2xl:mt-198 max-lg:max-w-lg max-md:-mt-120 max-lg:-mt-100 max-lg:py-30 h-full relative">
            <div className="max-xl:mb-2 mb-50 max-xl:-mt-10 mt-50">
                <div className="relative max-sm:p-5 flex max-xl:flex-col flex-col text-white max-xl:gap-7 gap-12 max-xl:mb-15">
                    ...
                    <div className="flex flex-row gap-4 absolute max-sm:mt-5 max-2xl:mt-4 mt-10 ml-12 items-center align-middle max-sm:ml-7">
                        <div  className="line-left max-sm:-mt-2 max-lg:-mt-1 max-2xl:-ml-5 -mt-1.5"/>
                    ...
                    <h2 className="font-chronicle-black font-semibold max-xl:text-6xl max-xl:max-w-full max-2xl:text-5xl text-9xl max-2xl:max-w-[400px] max-w-[600px]">What level of  hiker are you?</h2>
                    <p className="font-gilroy block leading-8 max-2xl:text-[18px] max-xl:max-w-full max-2xl:max-w-[720px] max-w-[400px]">Determining what level of hiker you are can be an important tool when planning future hikes. This hiking level guide will help you plan hikes according to different hike ratings set by various websites like All Trails and Modern Hiker. What type of hiker are you – novice, moderate, advanced moderate, expert, or expert backpacker? </p>
                    ...
                    {isMaxXL ? (
                        ...
                        <div className="flex relative flex-row ml-180 max-2xl:-mt-160 -mt-220 max-2xl:w-[450px] max-2xl:h-[650px] w-[600px] h-[800px] mb-5">
                            <img src="/images/01.png" alt="01" />
                        </div>
                    )}
            ...
            <div className="max-xl:mb-2 mb-40">
                <div className="relative max-sm:p-5 flex max-xl:flex-col flex-row text-white max-xl:gap-7 gap-12 max-xl:mb-15">
                    {isMaxXL ? (
                        ...
                        <>
                            <div className="flex absolute flex-row w-[600px] max-2xl:w-[500px] -ml-5 -mt-0  mb-5">
                                <img src="/images/02.png" alt="02" />
                            </div>
                            ...
                            <div className="ml-160 max-w-full mt-5 flex flex-col gap-9  relative mb-80">
                                ...
                                <div className="flex flex-row absolute gap-2 max-sm:mt-5 max-2xl:mt-4 items-center w-200 mt-10 ml-18 align-middle max-sm:ml-7">
                                    <div className="line-left max-sm:-mt-2 max-lg:-mt-1 max-2xl:-ml-10 -mt-1.5" />
                                    <h2 className="uppercase tracking-widest font-gilroy font-extrabold text-amber-200 max-2xl:text-2xl text-4xl">
                                        Hiking Essentials
                                    </h2>
                                </div>

                                <h2 className="font-chronicle-black font-semibold max-xl:text-6xl max-xl:max-w-full w-[800px] max-2xl:w-[600px] max-2xl:text-7xl text-9xl ">
                                    Picking the right Hiking Gear!
                                </h2>

                                <p className="font-gilroy block leading-8 max-2xl:text-[18px] max-xl:max-w-full max-w-[800px] max-2xl:w-[550px]">
                                    The nice thing about beginning hiking is that you don’t really need any special gear,
                                    you can probably get away with things you already have.
                                    Let’s start with clothing. A typical mistake hiking beginners make is wearing jeans
                                    and regular clothes, which will get heavy and chafe if they get sweaty or wet.
            ...
            <div className="max-xl:mb-2 mb-0">
                <div className="relative max-sm:p-5 flex max-xl:flex-col flex-col text-white max-xl:gap-7 gap-12 max-xl:mb-15 max-xl:-mt-2 -mt-50">
                    ...
                    <div className="flex flex-row gap-4 absolute max-sm:mt-0 max-2xl:mt-4  max-xl:-mt-0  mt-10 ml-12 items-center align-middle max-sm:ml-7">
                        <div  className="line-left max-sm:-mt-2 max-lg:-mt-1 max-2xl:-ml-4 -mt-1.5 ml-6"/>
                    ...
                    <h2 className="font-chronicle-black font-semibold max-xl:text-6xl max-xl:max-w-full max-2xl:text-5xl text-9xl max-2xl:max-w-[400px] max-w-[600px]">Understand Your Map & Timing</h2>
                    ...
                    {isMaxXL ? (
                        ...
                        <div className="flex relative flex-row ml-210 max-2xl:ml-180 max-2xl:h-[700px] max-2xl:-mt-130 -mt-230 max-2xl:w-[400px] w-[600px] h-[800px] mb-5">
                            <img src="/images/03.png" alt="03" />
                        </div>
                    )}
